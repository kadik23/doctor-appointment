...
function Message({message}) {
    if (message.type == "success") {
        return (
            <div id="toast-success" className="flex items-center w-full max-w-xs p-4 mb-4 text-gray-500 bg-white rounded-lg border-2 " role="alert">
    ...
    if (message.type == "error") {
        return (
            <div id="toast-warning" className="flex items-center w-full max-w-xs p-4 text-gray-500 bg-white rounded-lg border-2 shadow " role="alert">
