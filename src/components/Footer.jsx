...
function Footer() {
  return (
    <div className='w-full flex flex-col justify-around items-start p-10 h-56 bg-regal-green bg-opacity-10'>
        <div className='md:w-[40%] w-full flex justify-around'>
        ...
        <hr className='w-full md:w-[95%] border-1 md:ml-9 border-gray-400'/>
        <div className='md:w-[50%] w-full flex justify-around'>
